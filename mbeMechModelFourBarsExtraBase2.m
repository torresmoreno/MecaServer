classdef mbeMechModelFourBarsExtraBase2 < mbeMechModelBase
    ...
    methods(Access=public)
        ...
        function phiq = jacob_phi_q(me,q)
            ...
            %phiq(5,3) = 1; phiq(5,6) = L2B*sin(beta);
        ...
        function phiqpqp = jacob_phiqp_times_qp(me,q,qp)
            ...
            %dotphiq(5,3) = 0; dotphiq(5,6) = L2B*cos(beta)*betap;
            %--------------
%             dotphiq = [...
